...
#if defined(WCL_ModuleVersion) && defined(MODULE_WasteCalendarModule_ETS)

    #define ModuleVersion_ModuleName "WasteCalendarModule"
    #define ModuleVersion_knxprod_h WCL_ModuleVersion
    #define ModuleVersion_version_h MODULE_WasteCalendarModule_ETS
